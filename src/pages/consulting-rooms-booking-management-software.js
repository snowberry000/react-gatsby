...
const IndexPage = () => (
  <LayoutWrapper>
    <SEO title="Consulting Room Venue Management Software" SEO description="Specifically Designed Consulting Room & Space Management Software - Everything organised in one place, no double bookings, accept payments online -  no stress. " />
    <Header />
    <Section bgColor="accent3" height="20em" center>
      <Grid columns="100" breakAndCenter="900px">
        <div>
          <H1 center>Consulting Room Scheduling Software </H1>
          <h2 class="white-center">Manage your Consulting Rooms easier and faster than ever before. </h2>
    ...
    <Grid columns="50% 50%" breakAndCenter="900px">
      <div>
      <H2>Specifically Designed Venue and Space Management Software for Consulting Rooms.</H2>
      ...
      <div>
      <img src="https://justvenue.ams3.digitaloceanspaces.com/Hey-Agenda/Product-Pages/Product-Pages/consulting-room-therapy-venue-management-software.jpg" width="100%" alt="Consulting Room Venue Management Software"></img>
      </div>
    </Grid>
  </Section>
  <H2 center>Our Consulting Room Scheduling Features </H2>
    <Section>
      <FeatureInfoRow
        imgPosition="left"
